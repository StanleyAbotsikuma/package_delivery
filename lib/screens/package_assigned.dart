...
class AssignedPackage extends StatefulWidget {
  @override
  _AssignedPackageState createState() => _AssignedPackageState();
}

class _AssignedPackageState extends State<AssignedPackage> {
  String id;
  bool initFailed;
